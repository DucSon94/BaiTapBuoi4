...
public class QuanLyNhanVien {
    ...
    private NhanVienVanPhong[] nhapDanhSachNhanVienVanPhong() {
        boolean check = true;
        while (check) {
    ...
    private QuanLy[] nhapDanhSachQuanLy() {
        boolean check = true;
        while (check) {
    ...
    private void hienDanhSachCongNhan(CongNhan danhSach[]) {
        if (danhSach != null) {
            for (int i = 0; i < danhSach.length; i++) {
    ...
    private void hienDanhSachNhanVienVanPhong(NhanVienVanPhong danhSach[]) {
        if (danhSach != null) {
            for (int i = 0; i < danhSach.length; i++) {
    ...
    private void hienDanhSachQuanLy(QuanLy danhSachQuanLy[]) {
    ...
    private CongNhan congNhanCoThuNhapCaoNhatTheoGioiTinh(CongNhan danhSach[], GioiTinh gioiTinh) {
        if (danhSach != null) {
            int count = 0;
            for (int i = 0; i < danhSach.length; i++) {
    ...
    private NhanVienVanPhong nhanVienVanPhongCoThuNhapCaoNhatTheoGioitinh(NhanVienVanPhong danhSach[],
            GioiTinh gioiTinh) {
        if (danhSach != null) {
            int count = 0;
            for (int i = 0; i < danhSach.length; i++) {
    ...
    private QuanLy quanLyCoThuNhapCaoNhatTheoGioiTinh(QuanLy danhSach[], GioiTinh gioiTinh) {
    ...
    private CongNhan congNhanLuongCaoNhat(CongNhan danhSach[]) {
        if (danhSach != null) {
    ...
    private NhanVienVanPhong nhanVienVanPhongLuongCaoNhat(NhanVienVanPhong danhSach[]) {
        if (danhSach != null) {
    ...
    private QuanLy quanLyLuongCaoNhat(QuanLy danhSach[]) {
        if (danhSach != null) {
